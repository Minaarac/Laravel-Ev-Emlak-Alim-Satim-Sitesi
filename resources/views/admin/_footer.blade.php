...
<!-- ============================================================== -->
<!--morris JavaScript -->
<script src="{{asset('assets')}}/admin//assets/node_modules/raphael/raphael-min.js"></script>
<script src="{{asset('assets')}}/admin//assets/node_modules/morrisjs/morris.min.js"></script>
<script src="{{asset('assets')}}/admin//assets/node_modules/jquery-sparkline/jquery.sparkline.min.js"></script>
<!-- Popup message jquery -->
<script src="{{asset('assets')}}/admin//assets/node_modules/toast-master/js/jquery.toast.js"></script>
<!-- Chart JS -->
