...
<div class="container-fluid">
            ...
            <div class="card body-primary">
                ...
                <div class="card-body">
                    <div class="card">
                        <form class="form p-t-20" action="{{route('user_image_store',['product_id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                        ...
                        @foreach($images as $rs)
                            <tr>
                               ...
                               <td>
                                ...
                                <td>
                                    <a href="{{route('user_image_delete', ['id'=> $rs->id,'product_id'=>$data->id])}}" onclick="return confirm('Delete! Are you sure ?')">
